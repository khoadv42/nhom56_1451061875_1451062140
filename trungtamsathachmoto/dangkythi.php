		...
		<?php include 'xulydangkythi.php';?>
			<div id="content">
				...
				<form action="" method="post">
					...
					<input type="text" value="" name="txtHoTen" placeholder="" required><br>
					<label for="">Ngày Sinh</label><br>
					<input type="date" value="" name="txtNgaySinh" placeholder="yyyy-mm-dd" required><br>
					<label for="">Nơi Đăng Ký Hộ Khẩu Thường Trú</label><br>
					<input type="text" value="" name="txtDiaChi" placeholder="" required><br>
					<label for="">Số CMTND</label><br>
					<input type="number" value="" name="txtCmtnd" placeholder="" required><br>
					<label for="">Điện Thoại Liên Hệ</label><br>
					<input type="number" value="" name="txtSDT" placeholder="" required><br>
